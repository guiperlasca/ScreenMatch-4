...
INSERT INTO usuarios (id, login, senha, data_criacao) 
VALUES (1, 'admin', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iKTVEFDa', CURRENT_TIMESTAMP);
...
(1, 'Breaking Bad', 2008, 'Drama, Crime', 'Vince Gilligan', 'Bryan Cranston, Aaron Paul', 'Um professor de química se transforma em fabricante de metanfetamina', '/breaking-bad-poster.png', 9.5, CURRENT_TIMESTAMP),
(2, 'Game of Thrones', 2011, 'Drama, Fantasia', 'David Benioff, D.B. Weiss', 'Emilia Clarke, Kit Harington', 'Nobres famílias lutam pelo controle do Trono de Ferro', '/game-of-thrones-poster.png', 9.3, CURRENT_TIMESTAMP),
(3, 'Stranger Things', 2016, 'Drama, Fantasia, Horror', 'The Duffer Brothers', 'Millie Bobby Brown, Finn Wolfhard', 'Um grupo de crianças descobre segredos sobrenaturais', '/stranger-things-poster.png', 8.7, CURRENT_TIMESTAMP),
(4, 'The Crown', 2016, 'Drama, História', 'Peter Morgan', 'Olivia Colman, Helena Bonham Carter', 'A vida da Rainha Elizabeth II e da família real britânica', '/the-crown-poster.png', 8.6, CURRENT_TIMESTAMP),
(5, 'The Mandalorian', 2019, 'Ação, Aventura, Fantasia', 'Jon Favreau', 'Pedro Pascal, Gina Carano', 'Um caçador de recompensas em uma galáxia muito, muito distante', '/mandalorian-poster.png', 8.8, CURRENT_TIMESTAMP),
(6, 'The Witcher', 2019, 'Ação, Aventura, Fantasia', 'Lauren Schmidt Hissrich', 'Henry Cavill, Anya Chalotra', 'Um caçador de monstros em um mundo de magia e criaturas', '/witcher-poster.png', 8.2, CURRENT_TIMESTAMP);
